...
public class GuiExpirationOverrideSlider extends GuiButton
{
    ...
    public GuiExpirationOverrideSlider(GroupConfiguration group, int par1, int par2, int par3, double maxTime, boolean infinityAllowed, String par5Str, float par6)
    {
        ...
        adjustFromTime(this.group.getExpirationTimeOverride() / 60 / 1000);
        updateDisplayString();
    }
    ...
    protected void mouseDragged(Minecraft par1Minecraft, int par2, int par3)
    {
        if (this.visible)
        {
            if (this.dragging)
            {
                ...
                updateDisplayString();
                this.group.setExpirationTimeOverride(getTime() * 1000 * 60);
            }
    ...
    public boolean mousePressed(Minecraft par1Minecraft, int par2, int par3)
    {
        if (super.mousePressed(par1Minecraft, par2, par3))
        {
            ...
            updateDisplayString();
            this.group.setMaxViewDistanceOverride(getTime() * 1000 * 60);
            this.dragging = true;
            return true;
        }
        else
